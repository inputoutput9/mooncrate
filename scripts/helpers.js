...
const appAddress = '0xB49b96F6e004C9Be21dbb904dc6FB3710394dA58'; // your project address from thirdweb

export async function getApp() {
  const app = await sdk.getAppModule('0xB49b96F6e004C9Be21dbb904dc6FB3710394dA58');
  return app;
}
